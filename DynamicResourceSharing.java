// DynamicResourceSharing.java - Handles dynamic resource sharing among cities using union-find data structure
...
public class DynamicResourceSharing {
    ...
    // Initializes each city as its own cluster in the union-find structure
    ...
    // Finds the root (cluster representative) of a given city using path compression
    ...
    // Unites two clusters by linking their roots, ensuring minimal tree height using rank
